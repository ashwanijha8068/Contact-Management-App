...
const viewContact=()=>{
  ...
  return (
    <div id="contact_page">
        <Heading color={'white'} p={"10px 20px"} bg={"black"}>Contact Page</Heading>
        <div id="contact_page_div">
            {window.innerWidth>900?<Box padding={"10px"} w={"19%"} boxShadow={"rgba(5, 3, 45, 3.24) 0px 3px 8px"}>
            ...
            </Box>:<Flex justifyContent={"space-evenly"} w={"100%"} margin={'auto'} marginBottom={"20px"} p={"10px 0px"}  boxShadow={"rgba(5, 3, 45, 3.24)0px 3px 8px"}>
               <Box><Link style={{textDecoration:"none",fontSize:"20px",fontWeight:"bold"}} to="/">Contacts</Link></Box>
               <Box><Link style={{textDecoration:"none",fontSize:"20px",fontWeight:"bold"}} to="/chartsandmaps">Charts & Maps</Link></Box>
            </Flex>}
            <Box padding={"30px"} margin={'auto'}  w={"79%"} boxShadow={"rgba(5, 3, 45, 3.24) 0px 3px 8px"} border={"2px solid gray"}>
                            ...
                            {data.map((el)=>(
                              <div key={el.id}>
                                ...
                                <Popover >
                                   ...
                                   <PopoverContent backgroundColor={'#bbc1d6'} padding={'20px'} color='white' margin={'auto'}  >
